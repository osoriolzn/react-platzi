...
function CheckoutSideMenu () {
  ...
  return (
    <aside
      className={`${isCheckoutSideMenuOpen ? 'flex' : 'hidden'} flex-col fixed right-0 border border-black rounded-lg bg-white overflow-scroll top-[68px] w-[360px] h-[calc(100vh-68px)] top`}
    >
